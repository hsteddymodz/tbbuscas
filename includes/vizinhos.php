...
function vizinhos($vizinhos, $chat_id) {
    // Montar a URL da API com o número de telefone
    $url = "https://teddy-puxadas.onrender.com/vizinhos/$vizinhos?apiKey=tpteddy";
